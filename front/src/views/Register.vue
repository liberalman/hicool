        ...
        <div class="formWrap">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="ruleForm">
                ...
                <el-form-item label="确认密码" prop="confirm_password">
                    <el-input type="password" v-model="ruleForm.confirm_password" auto-complete="off" style="width: 200px;"></el-input>
                </el-form-item>
                ...
                <el-form-item>
                    <el-button type="primary" @click="submitForm('ruleForm')" @keyup.enter="submitForm('ruleForm')" style="width: 200px;">注册</el-button>
                </el-form-item>
                <el-form-item>
